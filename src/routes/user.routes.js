...
router.post('/register', registerController.registerEmpresa)
...
// Edicion y baja de usuarios: solo el administrador de la empresa
router.put('/:id', requireLogin, requireRol('admin_empresa'), userController.actualizarUsuario)
router.put('/:id/estado', requireLogin, requireRol('admin_empresa'), userController.cambiarEstadoUsuario)
